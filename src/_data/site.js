...
module.exports = {
  ...
  author: "Tyler Green",
  description: "Essays on technical depth, local belonging, and building a life outside the usual scripts.",
  shortDescription: "Technical depth and local belonging, built from scratch.",
